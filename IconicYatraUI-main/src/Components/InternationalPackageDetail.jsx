      ...
      <Box sx={{
        ...
        <Box sx={{ textAlign: "center", color: "white" }}>
          ...
          <Typography variant="h6" fontWeight="300">
            Loading Amazing International Package...
          </Typography>
        </Box>
      </Box>
    );
      ...
      <Box sx={{
        ...
        <Box sx={{ textAlign: "center", color: "white" }}>
          ...
          <Typography variant="body1" sx={{ opacity: 0.9 }}>
            The international package you're looking for doesn't exist.
          </Typography>
        </Box>
      </Box>
    );
          ...
          <Box sx={{
            ...
            <Box sx={{
              ...
              <Container maxWidth="lg">
                <Chip
                  label={packageData.tourType || "International Package"}
                  sx={{
                ...
                <Box sx={{ display: "flex", alignItems: "center", gap: 2, flexWrap: "wrap" }}>
                  <Box sx={{ display: "flex", alignItems: "center" }}>
                    <Public sx={{ mr: 0.5, fontSize: "1.2rem" }} />
                    <Typography variant="h6" fontWeight="300">
      ...
      <Container maxWidth="lg" sx={{ py: 6 }}>
        ...
        <Paper sx={{ mb: 4, borderRadius: 3, overflow: "hidden", boxShadow: 3 }}>
          ...
          >
            ...
            <Tab label="Hotels & Stays" icon={<Hotel />} iconPosition="start" />
          </Tabs>
        </Paper>
        ...
        <Box sx={{ mt: 4 }}>
              ...
              <Grid size={{ xs: 12, md: 8 }}>
                <Card sx={{ p: 4, borderRadius: 3, boxShadow: 3 }}>
                  <Typography variant="h5" fontWeight="bold" gutterBottom color="primary">
                    About This International Package
                  </Typography>
                  <Typography variant="body1" paragraph sx={{ lineHeight: 1.8, fontSize: "1.1rem" }}>
                    {packageData.notes || "Embark on an unforgettable international journey through exotic destinations and cultural experiences. This specially curated international package offers the perfect blend of adventure, luxury, and cultural immersion across global destinations."}
                  </Typography>

                  {/* Highlights */}
                  <Box sx={{ mt: 4 }}>
                    <Typography variant="h6" fontWeight="bold" gutterBottom>
                      🌟 International Package Highlights
                    </Typography>
                        ...
                        <List>
                          <ListItem>
                            ...
                            <ListItemText
                              ...
                              secondary="Luxury stays in premium international hotels"
                            />
                          </ListItem>
                          <ListItem>
                            <ListItemIcon>
                            ...
                            <ListItemText
                              primary="Global Cuisine"
                              secondary={packageData.mealPlan?.planType || "International dining experiences"}
                            />
                          </ListItem>
                        </List>
                      </Grid>
                        ...
                        <List>
                          <ListItem>
                            ...
                            <ListItemText
                              ...
                              secondary="Comfortable international travel arrangements"
                            />
                          </ListItem>
                          <ListItem>
                            <ListItemIcon>
                            ...
                            <ListItemText
                              primary="Global Guides"
                              secondary="Expert local guides in each destination"
                            />
                          </ListItem>
                        </List>
                      </Grid>
                ...
                <Card sx={{ p: 3, borderRadius: 3, boxShadow: 3, background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)", color: "white" }}>
                  ...
                  <List>
                    ...
                    <ListItem>
                      ...
                      <ListItemText
                        primary="Country"
                        secondary={packageData.destinationCountry}
                      />
                    </ListItem>
                    <ListItem>
                      <ListItemIcon sx={{ color: "white", minWidth: 40 }}>
          ...
          {activeTab === 1 && packageData.days && packageData.days.length > 0 && (
            <Box>
              <Typography variant="h4" fontWeight="bold" gutterBottom sx={{ mb: 4, textAlign: "center" }}>
                🌍 Your International Journey Itinerary
              </Typography>
                        ...
                        {dayItem.sightseeing && dayItem.sightseeing.length > 0 && (
                          <Box>
                            <Typography variant="subtitle1" fontWeight="bold" gutterBottom>
                              🏛️ International Sightseeing Highlights:
                            </Typography>
          ...
          {activeTab === 3 && packageData.destinationNights && (
            <Box>
              <Typography variant="h4" fontWeight="bold" gutterBottom sx={{ mb: 4, textAlign: "center" }}>
                🏨 International Accommodation Details
              </Typography>
                  ...
                  <CardContent sx={{ p: 4 }}>
                    ...
                    <Box sx={{ mt: 3, p: 2, backgroundColor: 'info.light', borderRadius: 2 }}>
                      <Typography variant="body2" sx={{ fontStyle: 'italic' }}>
                        🌟 <strong>International Standards:</strong> All hotels maintain international quality standards. Final hotel selections are subject to availability and will be confirmed at the time of booking.
                      </Typography>
                    </Box>
                  </CardContent>
                </Card>
              ...
              {/* Fallback for packages without destinationNights but with stayLocations */}
              {(!packageData.destinationNights || packageData.destinationNights.length === 0) &&
                packageData.stayLocations && packageData.stayLocations.length > 0 && (
                  <Grid container spacing={3}>
                    {packageData.stayLocations.map((location, index) => (
                      <Grid size={{ xs: 12, md: 6 }} key={index}>
                        <Card sx={{ p: 3, borderRadius: 3, boxShadow: 3 }}>
                          ...
                          <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
                            {location.nights} Night(s) Stay
                          </Typography>
                          <Typography variant="body2" color="text.secondary">
                            Luxury international accommodation with premium amenities and services.
                          </Typography>
                        </Card>
                      </Grid>
                    ))}
