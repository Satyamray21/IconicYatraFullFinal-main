...
export const createBlog = createAsyncThunk(
    ...
    async (formData, thunkApi) => {
        try {
            const res = await blogsAxios.post('/blogs', formData, {
                headers: {
...
export const getAllBlogs = createAsyncThunk(
    ...
    async (params = {}, thunkApi) => {
        try {
            ...
            const res = await blogsAxios.get(`/blogs?${queryParams}`);
            return res.data;
        } catch (err) {
...
export const getBlogByIdentifier = createAsyncThunk(
    ...
    async (identifier, thunkApi) => {
        try {
            const res = await blogsAxios.get(`/blogs/${identifier}`);
            return res.data;
        } catch (err) {
            return thunkApi.rejectWithValue(err?.response?.data?.message);
        }
...
export const updateBlog = createAsyncThunk(
    ...
    async ({ id, formData }, thunkApi) => {
        try {
            const res = await blogsAxios.put(`/blogs/${id}`, formData, {
                headers: {
                    'Content-Type': 'multipart/form-data'
                }
            });
...
export const deleteBlog = createAsyncThunk(
    ...
    async (id, thunkApi) => {
        try {
            const res = await blogsAxios.delete(`/blogs/${id}`);
...
export const getBlogsByCategory = createAsyncThunk(
    ...
    async ({ category, limit = 10 }, thunkApi) => {
        try {
            const res = await blogsAxios.get(`/blogs/category/${category}?limit=${limit}`);
            return res.data;
        } catch (err) {
            return thunkApi.rejectWithValue(err?.response?.data?.message);
        }
...
export const getRelatedBlogs = createAsyncThunk(
    ...
    async ({ id, limit = 3 }, thunkApi) => {
        try {
            const res = await blogsAxios.get(`/blogs/${id}/related?limit=${limit}`);
            return res.data;
        } catch (err) {
            return thunkApi.rejectWithValue(err?.response?.data?.message);
        }
...
export const getBlogStats = createAsyncThunk(
    ...
    async (_, thunkApi) => {
        try {
            const res = await blogsAxios.get('/blogs/stats');
            return res.data;
        } catch (err) {
            return thunkApi.rejectWithValue(err?.response?.data?.message);
        }
