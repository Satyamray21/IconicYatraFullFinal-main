...
const ContactUs = () => {
  ...
  return (
    <>
      ...
      >
        <Grid container spacing={4} sx={{ px: { xs: 2, md: 8 }, maxWidth: 1400, mx: 'auto' }}>
                ...
                <Box position="relative" zIndex={1}>
                  ...
                  <Stack direction="row" spacing={2} alignItems="flex-start" mt={3}>
                    ...
                    <Box>
                      ...
                      <Typography sx={{ mt: 0.5 }}>{company?.company?.address}</Typography>
                    </Box>
                  </Stack>
                  ...
                  <Stack direction="row" spacing={2} alignItems="center" mt={3}>
                    ...
                    <Box>
                      ...
                      <Typography sx={{ mt: 0.5 }}>{company?.company?.email}</Typography>
                    </Box>
                  </Stack>
                </Box>
              </Paper>
