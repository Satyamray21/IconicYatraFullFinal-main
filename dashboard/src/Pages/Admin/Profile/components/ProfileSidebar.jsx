    ...
    >
      ...
      <Box sx={{ p: 2 }}>
        <List>
          ...
          >
            <ListItemIcon>
              <PersonIcon color={activeTab === "profile" ? "primary" : "inherit"} />
            </ListItemIcon>
          ...
          >
            ...
            <ListItemText primary="Inside Companies" />
          </ListItem>
          ...
          >
            <ListItemIcon>
              <CollectionsBookmarkIcon
                color={activeTab === "gallery" ? "primary" : "inherit"}
              />
            </ListItemIcon>
          ...
          <ListItem
            sx={{
              ...menuItemStyle,
              ...(activeTab === "bankDetails" && activeStyle)
            }}
            onClick={() => setActiveTab("bankDetails")}
          >
            <ListItemIcon>
              <AccountBalanceIcon
                color={activeTab === "bankDetails" ? "primary" : "inherit"}
              />
            </ListItemIcon>
          ...
          {user?.userRole === "Admin" && (
            <>
              ...
              >
                <ListItemIcon>
                  <AddIcon color={activeTab === "admin" ? "primary" : "inherit"} />
                </ListItemIcon>
