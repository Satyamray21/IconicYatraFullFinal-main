...
const VehicleQuotationPDFDialog = ({
  ...
  const policiesInclusions = getPoliciesArray(
    getValue(quotationData, "policies.inclusions", []),
  );
  const policiesExclusions = getPoliciesArray(
    getValue(quotationData, "policies.exclusions", []),
  );
  const paymentPolicy = getValue(quotationData, "policies.paymentPolicy", "");
  const cancellationPolicyFromQuot = getPoliciesArray(
    getValue(quotationData, "policies.cancellationPolicy", []),
  );
  const termsConditions = getValue(quotationData, "policies.terms", "");

  // Use global defaults as fallbacks
  const finalInclusionArray =
    policiesInclusions.length > 0
      ? policiesInclusions
  ...
  const companyCancellationUrl =
    selectedCompany?.cancellationPolicy ||
    "https://www.iconicyatra.com/cancellationandrefundpolicy";
    ...
    >
      ...
      >
        {finalInclusionArray.length > 0 ? (
          ...
          <div
            style={{ fontSize: "13px", marginLeft: "20px", lineHeight: "1.5" }}
          >
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      ...
      >
        ...
        >
          <div
            style={{ fontWeight: "bold", fontSize: "18px", color: "#1976d2" }}
          >
      ...
      <DialogContent dividers sx={{ p: 0, bgcolor: "#f0f0f0" }}>
        ...
        <div
          ref={printRef}
          style={{ display: imagesLoaded && renderComplete ? "block" : "none" }}
        >
          ...
          >
            ...
            <div style={{ textAlign: "center", marginBottom: "30px" }}>
              ...
              >
                <span>
                  <strong>Ref No:</strong> {reference}
                </span>
                <span>
            ...
            >
              ...
              >
                <Person sx={{ mr: 1, verticalAlign: "middle" }} /> Customer
                Details
              </Typography>
            ...
            >
              ...
              >
                ...
                >
                  <Route sx={{ mr: 1, verticalAlign: "middle" }} /> Pickup
                  Details
                </Typography>
                <Typography variant="body2" sx={{ whiteSpace: "pre-line" }}>
                  {pickupArrival || "Not specified"}
                </Typography>
              </div>
              <div
                style={{
              ...
              >
                <Typography
                  ...
                  sx={{ mb: 2, color: "#1976d2" }}
                >
                  <DirectionsCar sx={{ mr: 1, verticalAlign: "middle" }} /> Drop
                  Details
                </Typography>
                <Typography variant="body2" sx={{ whiteSpace: "pre-line" }}>
                  {pickupDeparture || "Not specified"}
                </Typography>
              </div>
            </div>
          ...
          >
              ...
              <div style={{ marginBottom: "35px" }}>
                ...
                >
                  <div style={{ marginBottom: "10px" }}>
                    ...
                    . Use this name exactly as the account / beneficiary name
                    when paying via net banking, NEFT, RTGS, or IMPS.
                  </div>
                  {companyPaymentLink && (
            ...
            <div style={{ textAlign: "center" }}>
              ...
              {footerContact && (
                <div
                  style={{ fontSize: "10px", color: "#666", marginTop: "5px" }}
                >
                  👤 Contact: {footerContact}
                  {footerContactDesignation
                    ? ` (${footerContactDesignation})`
                    : ""}
                </div>
              )}
              <div
                style={{ fontSize: "9px", color: "#999", marginTop: "10px" }}
              >
                This is a computer generated quotation. No signature required.
              </div>
              <div style={{ fontSize: "9px", color: "#999", marginTop: "3px" }}>
                © {new Date().getFullYear()} {footerCompany}. All rights
                reserved.
              </div>
            </div>
          </div>
