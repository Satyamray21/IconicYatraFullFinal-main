...
const CustomQuotationStep4 = ({
  ...
  const actualArrivalCity =
    arrivalCity || (cities && cities[0]?.cityName) || "TBD";
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        formData.append(
          "quotationId",
          localStorage.getItem("currentQuotationId"),
        );
  ...
  useEffect(() => {
    if (totalDays > 0) {
      const newDays = generateDaysArray(
        cities,
        totalDays,
        actualArrivalCity,
        actualDepartureCity,
      ...
      <Paper sx={{ p: 3, position: "relative" }}>
        ...
        <Box sx={{ mb: 3, p: 2, backgroundColor: "#f5f5f5", borderRadius: 1 }}>
          ...
          <Typography variant="caption" color="textSecondary">
            Itinerary is automatically generated based on your selected cities.
            You can customize each day below.
          </Typography>
        </Box>
