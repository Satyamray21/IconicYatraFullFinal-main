...
const CustomQuotationStep5 = ({
  ...
  const [clients, setClients] = useState(
    [clientName || "Client A"].filter(Boolean),
  );
  ...
  const formik = useFormik({
    ...
    initialValues: {
      ...
      noOfDays:
        vehicleDetails?.basicsDetails?.noOfDays ||
        parseInt(vehicleDetails?.basicsDetails?.noOfDays) ||
        1, // Parse string
      noOfDaysManuallyEdited: false,

      perDayCost:
        vehicleDetails?.costDetails?.perDayCost ??
    ...
    onSubmit: (values) => {
      ...
      const payload = {
        ...
        costDetails: {
          ...
          driverAllowance:
            values.driverAllowance === "" ? 0 : Number(values.driverAllowance),
          tollParking:
            values.tollParking === "" ? 0 : Number(values.tollParking),
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDateFns}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid size={{ xs: 12, sm: 4 }}>
                <TextField
                  ...
                  onChange={(e) =>
                    formik.setFieldValue("tripType", e.target.value)
                  }
              ...
              <Grid size={{ xs: 12, sm: 4 }}>
                <TextField
                  ...
                  onChange={(e) =>
                    formik.setFieldValue("perDayCost", e.target.value)
                  }
                />
              </Grid>
              ...
              <Grid size={{ xs: 12, sm: 4 }}>
                <TextField
                  ...
                  onChange={(e) =>
                    formik.setFieldValue("ratePerKm", e.target.value)
                  }
                />
              </Grid>
              ...
              <Grid size={{ xs: 12, sm: 4 }}>
                <TextField
                  ...
                  onChange={(e) =>
                    formik.setFieldValue("kmPerDay", e.target.value)
                  }
                />
              </Grid>
            </Grid>
            ...
            <Grid container spacing={2}>
              <Grid size={{ xs: 12, sm: 4 }}>
                <TextField
                  ...
                  onChange={(e) =>
                    formik.setFieldValue("driverAllowance", e.target.value)
                  }
                />
              </Grid>
              ...
              <Grid size={{ xs: 12, sm: 4 }}>
                <TextField
                  ...
                  onChange={(e) =>
                    formik.setFieldValue("tollParking", e.target.value)
                  }
                />
              </Grid>
            ...
            <Grid container spacing={2}>
              ...
              <Grid size={{ xs: 12, sm: 4 }}>
                <DatePicker
                  ...
                  onChange={(v) => {
                    ...
                    if (
                      !formik.values.noOfDaysManuallyEdited &&
              ...
              <Grid size={{ xs: 12, sm: 4 }}>
                <TextField
                  ...
                  onChange={(e) =>
                    formik.setFieldValue("pickupLocation", e.target.value)
                  }
                  error={
              ...
              <Grid size={{ xs: 12, sm: 4 }}>
                <TextField
                  ...
                  onChange={(e) =>
                    formik.setFieldValue("dropLocation", e.target.value)
                  }
                  error={
      ...
      <Dialog open={openDialog} onClose={() => setOpenDialog(false)}>
        <DialogTitle>
          {fieldType === "client" ? "Add Client" : "Add Vehicle Type"}
        </DialogTitle>
        <DialogContent>
          <TextField
            autoFocus
