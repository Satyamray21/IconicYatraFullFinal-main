  ...
  async ({ vehicleQuotationId, itinerary }, thunkApi) => {
    try {
      const res = await axios.post(
        `/vehicleQT/${vehicleQuotationId}/itinerary`,
        {
          itinerary,
        },
      );
...
// ========== VEHICLE EMAIL PREVIEW ==========
// ========== VEHICLE EMAIL PREVIEW ==========
export const previewVehicleQuotationMail = createAsyncThunk(
  "vehicleQuotation/previewVehicleQuotationMail",
  async ({ vehicleQuotationId, companyId, companyName }, thunkApi) => {
    try {
      const res = await axios.get(`/vehicleQT/email/preview/${vehicleQuotationId}`, {
        params: {
      ...
      return thunkApi.rejectWithValue(
        err?.response?.data?.message ||
          "Failed to preview vehicle quotation email",
      );
    }
  },
);
...
// ========== VEHICLE EMAIL SEND ==========
export const sendVehicleQuotationMail = createAsyncThunk(
  "vehicleQuotation/sendVehicleQuotationMail",
  async ({ vehicleQuotationId, data = {} }, thunkApi) => {
    try {
      const res = await axios.post(
      ...
      return thunkApi.rejectWithValue(
        err?.response?.data?.message ||
          "Failed to send vehicle quotation email",
      );
    }
  },
);
...
export const finalizeVehicleQuotation = createAsyncThunk(
  "vehicleQuotation/finalizeVehicleQuotation",
  async ({ vehicleQuotationId, data = {} }, thunkApi) => {
    try {
      const res = await axios.post(
